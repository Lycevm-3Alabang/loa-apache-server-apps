...
- [ ] Domain slice B — appointments/academic/semesters — B1+B2 **green pasted**; B3 landed (awaiting suite green): `AvailabilityRuleController` (groups-claim ownership, forced-self, ADMIN-other + fail-soft audit, 400 `{error}` validation) + gated routes + `AvailabilityTest` 10 tests
...
- [x] 2026-09-22 — B2 **green pasted**: `000012` appointment-family tables + 5 thin models + `AppointmentTablesTest` 3/3
