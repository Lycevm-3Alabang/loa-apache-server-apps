  ...
  "data": [
    {
      ...
      "certificate": { "id": "uuid", "revoked_at": null, "expires_at": null },
...
Each item carries REQUIRED `certificate` (`{ id, revoked_at, expires_at }` when linked, `null` when `certificate_id` is null) — drives the roster Revoked badge + resend disable (CERT-SOURCE-001 §12).
