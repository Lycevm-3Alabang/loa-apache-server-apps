...
<div class="page-header">
    ...
    <a class="button button-ghost" href="{{ route('admin.users.import') }}" style="border-color:var(--border);color:var(--text-secondary);">Start New Import</a>
</div>
...
<div class="detail-card" style="margin-bottom:1.5rem;">
    ...
    <a class="button button-ghost" href="{{ route('admin.users.import.failed') }}" style="border-color:var(--border);">Download Failed CSV</a>
</div>
@endif
    ...
    <table>
        ...
        <tbody>
            ...
            <tr data-status="{{ $row['status'] }}">
                ...
                <td class="muted">{{ $row['remarks'] ?? ($row['_error'] ?? '') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
