...
INSERT INTO `group_claims` (`id`, `group_id`, `claim_key`, `scope_type`, `scope_id`, `created_at`, `updated_at`) VALUES (1,2,'users.view','none',NULL,'2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `group_claims` (`id`, `group_id`, `claim_key`, `scope_type`, `scope_id`, `created_at`, `updated_at`) VALUES (2,2,'users.manage','none',NULL,'2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `group_claims` (`id`, `group_id`, `claim_key`, `scope_type`, `scope_id`, `created_at`, `updated_at`) VALUES (3,3,'users.view','none',NULL,'2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `group_claims` (`id`, `group_id`, `claim_key`, `scope_type`, `scope_id`, `created_at`, `updated_at`) VALUES (4,3,'users.manage','none',NULL,'2026-09-20 19:08:49','2026-09-20 19:08:49');
...
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (1,'users.view','View user list and details',NULL,'2026-09-20 19:08:47','2026-09-20 19:08:47');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (2,'users.manage','Enable/disable users, manage status',NULL,'2026-09-20 19:08:47','2026-09-20 19:08:47');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (3,'groups.view','View groups',NULL,'2026-09-20 19:08:48','2026-09-20 19:08:48');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (4,'groups.manage','Create, edit, delete groups',NULL,'2026-09-20 19:08:48','2026-09-20 19:08:48');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (5,'permissions.view','View permissions',NULL,'2026-09-20 19:08:48','2026-09-20 19:08:48');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (6,'permissions.manage','Assign permissions to groups',NULL,'2026-09-20 19:08:48','2026-09-20 19:08:48');
INSERT INTO `permissions` (`id`, `key`, `description`, `endpoint_pattern`, `created_at`, `updated_at`) VALUES (7,'auth.verify','Validate tokens (internal)',NULL,'2026-09-20 19:08:48','2026-09-20 19:08:48');
...
INSERT INTO `tenants` (`id`, `slug`, `name`, `status`, `app_url`, `dev_app_url`, `redirect_origins`, `dev_redirect_origins`, `created_at`, `updated_at`) VALUES ('91128f0a-df85-47a9-ae1d-5298904dacd5','loa-e-cert','Vericert','active','https://staging-loa-vericert.vercel.app','http://localhost:3000','[\"https://staging-loa-vericert.vercel.app\"]','[\"http://localhost:3000\"]','2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `tenants` (`id`, `slug`, `name`, `status`, `app_url`, `dev_app_url`, `redirect_origins`, `dev_redirect_origins`, `created_at`, `updated_at`) VALUES ('a6bba821-e012-41a4-903a-fd163cb3ae08','auth','LOA Auth Platform','active',NULL,NULL,'[]','[]','2026-09-20 19:08:49','2026-09-20 19:08:49');
...
INSERT INTO `user_groups` (`id`, `name`, `description`, `priority`, `tenant_id`, `created_at`, `updated_at`) VALUES (1,'loa-auth-admin','Platform administrator',10,NULL,'2026-09-20 19:08:47','2026-09-20 19:08:47');
INSERT INTO `user_groups` (`id`, `name`, `description`, `priority`, `tenant_id`, `created_at`, `updated_at`) VALUES (2,'cert-admin','Local certificate administrator',2,'91128f0a-df85-47a9-ae1d-5298904dacd5','2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `user_groups` (`id`, `name`, `description`, `priority`, `tenant_id`, `created_at`, `updated_at`) VALUES (3,'cert-staff','Local certificate staff',3,'91128f0a-df85-47a9-ae1d-5298904dacd5','2026-09-20 19:08:49','2026-09-20 19:08:49');
INSERT INTO `user_groups` (`id`, `name`, `description`, `priority`, `tenant_id`, `created_at`, `updated_at`) VALUES (4,'cert-user','Local certificate user',4,'91128f0a-df85-47a9-ae1d-5298904dacd5','2026-09-20 19:08:49','2026-09-20 19:08:49');
...
INSERT INTO `user_user_group` (`user_id`, `user_group_id`, `created_at`, `updated_at`) VALUES ('d62a9488-b7dc-43b3-8dfe-1bfeed642f09',1,NULL,NULL);
...
INSERT INTO `users` (`id`, `email`, `password`, `name`, `status`, `failed_attempts`, `locked_until`, `created_at`, `updated_at`) VALUES ('d62a9488-b7dc-43b3-8dfe-1bfeed642f09','admin@lyceumalabang.edu.ph','$2y$12$p89/FHqqVpYh5Xm.Rc4LHuLNRjUFP/zilSyCpm/MxdMPFceVPw3c6','Super Admin','active',0,NULL,'2026-09-20 19:08:49','2026-09-20 19:08:49');
...
-- Dump completed on 2026-09-20 11:31:31