...
- **Consumed by:** `business-contexts/consultation/` (academic entities in booking flows), `business-contexts/evaluation/` (subjects, sections, enrollments in evaluation flows), `assemblies/loa-consult-platform/` (academic module).
- **Contracts:** none.
