...
- **Source of truth:** `api-endpoints.md` Final v1.10 (gated list/show `generation_mode` + `?source=` filter), `certificate-source-spec.md` Final v1.1 (CERT-SOURCE-001), `legacy-e-cert-integration.md` Final v2.2, `authenticated-endpoints-spec.md` v1.2.
