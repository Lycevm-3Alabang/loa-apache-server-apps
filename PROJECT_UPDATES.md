...
- **Source of truth:** `api-endpoints.md` Final v1.12 (Me list/detail `generation_mode`), `certificate-source-spec.md` Final v1.3 (CERT-SOURCE-001), `legacy-e-cert-integration.md` Final v2.2, `authenticated-endpoints-spec.md` v1.2.
